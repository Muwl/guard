...
public  abstract class AbstractUVCCameraHandler extends Handler {
	...
	public static OnPreViewDateLister mOnPreViewDateLister;
	...
	public interface OnPreViewDateLister{
		void onPreviewFrame(byte[] data);
	}

	public static void setmOnPreViewDateLister(OnPreViewDateLister mOnPreViewDateLister) {
		AbstractUVCCameraHandler.mOnPreViewDateLister = mOnPreViewDateLister;
	}
...
//				mUVCCamera.setPreviewSize(mWidth, mHeight, 1, 31, mPreviewMode, mBandwidthFactor);
				mUVCCamera.setPreviewSize(mWidth, mHeight, 30, 32, UVCCamera.DEFAULT_PREVIEW_MODE, mBandwidthFactor);
...
//				}
				if (mOnPreViewDateLister!=null){
					mOnPreViewDateLister.onPreviewFrame(yuv.clone());
				}
			}
		};
