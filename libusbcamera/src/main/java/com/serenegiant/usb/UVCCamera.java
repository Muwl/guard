...
public class UVCCamera {
	...
	public static final int DEFAULT_PREVIEW_WIDTH = Constants.PREVIEWWIDTH;
	public static final int DEFAULT_PREVIEW_HEIGHT = Constants.PREVIEWHEIGHT;
    ...
    public synchronized void open(final UsbControlBlock ctrlBlock) {
    	...
    	try {
			...
			Log.e("===========",mNativePtr+"==="+mCtrlBlock.getVenderId()+"=="+mCtrlBlock.getProductId()+"=="+mCtrlBlock.getFileDescriptor()+"=="+mCtrlBlock.getBusNum()+"=="+mCtrlBlock.getDevNum()+"=="+getUSBFSName(mCtrlBlock));
